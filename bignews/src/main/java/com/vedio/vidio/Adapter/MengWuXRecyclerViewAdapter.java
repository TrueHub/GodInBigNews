 ...
 */
public class MengWuXRecyclerViewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    private LayoutInflater inflater;
    private Context context;
    private ArrayList<MengWuBean.VAP4BFR16Bean> list;
    private JCVideoPlayerStandard currentVideo;

    public MengWuXRecyclerViewAdapter(ArrayList<MengWuBean.VAP4BFR16Bean> list, LayoutInflater inflater, Context context) {
