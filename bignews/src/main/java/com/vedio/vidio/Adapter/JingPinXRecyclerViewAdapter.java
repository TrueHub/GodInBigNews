 ...
 */
public class JingPinXRecyclerViewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    private LayoutInflater inflater;
    private Context context;
    private ArrayList<JingPinBean.VAP4BGTVDBean> list;
    private JCVideoPlayerStandard currentVideo;

    public JingPinXRecyclerViewAdapter(ArrayList<JingPinBean.VAP4BGTVDBean> list, LayoutInflater inflater, Context context) {
