 ...
 */
public class QiPaXRecyclerViewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    private LayoutInflater inflater;
    private Context context;
    private ArrayList<QiPaBean.VAP4BFE3UBean> list;
    private JCVideoPlayerStandard currentVideo;

    public QiPaXRecyclerViewAdapter(ArrayList<QiPaBean.VAP4BFE3UBean> list, LayoutInflater inflater, Context context) {
