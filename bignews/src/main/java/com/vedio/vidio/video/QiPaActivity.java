...
import com.bignews9527.vidio.Adapter.QiPaXRecyclerViewAdapter;
 ...
 */
public class QiPaActivity extends FragmentActivity {
    ...
    private ArrayList<QiPaBean.VAP4BFE3UBean> list = new ArrayList<>();
    ...
    private void initAdapter() {
        ...
        video_qipa_xrecyclerview.setAdapter(video_qipa_xrecyclerview_adapter = new QiPaXRecyclerViewAdapter(list, inflater, QiPaActivity.this));
            ...
            public void run() {
                try {
                    ...
                    if (conn.getResponseCode() == 200) {
                        ...
                        QiPaBean bean = new Gson().fromJson(sb.toString(), QiPaBean.class);
