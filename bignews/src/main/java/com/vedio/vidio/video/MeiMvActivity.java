...
import com.bignews9527.vidio.Adapter.MeiNvXRecyclerViewAdapter;
 ...
 */
public class MeiMvActivity extends FragmentActivity {
    ...
    private ArrayList<MeiMvBean.VAP4BG6DLBean> list = new ArrayList<>();
    ...
    private void initAdapter() {
        ...
        video_qipa_xrecyclerview.setAdapter(video_qipa_xrecyclerview_adapter = new MeiNvXRecyclerViewAdapter(list, inflater, MeiMvActivity.this));
...
//                .enqueue(new Callback<QiPaBean>() {
//                    @Override
//                    public void onResponse(Call<QiPaBean> call, Response<QiPaBean> response) {
//
...
//
//                    @Override
//                    public void onFailure(Call<QiPaBean> call, Throwable t) {
//
//                    }
//                });
            ...
            public void run() {
                try {
                    ...
                    if (conn.getResponseCode() == 200) {
                        ...
                        MeiMvBean bean = new Gson().fromJson(sb.toString(), MeiMvBean.class);
                        list.addAll(bean.getVAP4BG6DL());
...
//                        QiPaBean bean = new Gson().fromJson(info, QiPaBean.class);
