...
import com.bignews9527.vidio.Adapter.JingPinXRecyclerViewAdapter;
import com.bignews9527.vidio.beans.JingPinBean;
 ...
 */
public class JingPinActivity extends FragmentActivity {
    ...
    private ArrayList<JingPinBean.VAP4BGTVDBean> list = new ArrayList<>();
    ...
    private void initAdapter() {
        ...
        video_qipa_xrecyclerview.setAdapter(video_qipa_xrecyclerview_adapter = new JingPinXRecyclerViewAdapter(list, inflater, JingPinActivity.this));
...
//                .enqueue(new Callback<JingPinBean>() {
//                    @Override
//                    public void onResponse(Call<JingPinBean> call, Response<JingPinBean> response) {
//
...
//
//                    @Override
//                    public void onFailure(Call<JingPinBean> call, Throwable t) {
//
//                    }
//                });
            ...
            public void run() {
                try {
                    ...
                    if (conn.getResponseCode() == 200) {
                        ...
                        JingPinBean bean = new Gson().fromJson(sb.toString(), JingPinBean.class);
                        list.addAll(bean.getVAP4BGTVD());
...
//                        JingPinBean bean = new Gson().fromJson(info, JingPinBean.class);
