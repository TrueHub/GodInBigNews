...
public class HttpConnectAndPullReadConent {
    ...
    public ReadArticleBean httpFunction() {//暂时放在本类中，功能完善后封装为一个独立的类，提高代码可读性
...
//                        开始解析imgs数组
                ...
                try {
                    ...
                    for (int i = 0; i < relativeArray.length(); i++) {
                        ...
                        String docId = relativeObj.getString("docID");
                        relativeSysBean.setDocID(docId);
...
/*                try {
                    ...
                    List<ReadArticleBean.ArticleBean.> huatiList = new ArrayList<>();
